                  ...
                  {filteredSearchResults.map((result) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center justify-between w-full p-3 border border-slate-200 rounded-lg hover:border-emerald-300 hover:bg-emerald-50 transition-all text-left"
                      >
                        <div className="flex items-center gap-3">
